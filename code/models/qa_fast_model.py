...
class QA_fast_model(BaseModel):
    ...
    def train_step(self, batch):
        ...
        Create a mask to exclude the correct class probabilities
        ...
        """
        Ranking loss to ensure correct class probability is higher than
    ...
    def validation_step(self, batch):
        ...
        mask = batch["decoder_start"].squeeze() == 1250
        logits = logits[mask]  # only keep seperator tokens
        probs = torch.softmax(logits, dim=-1)
        return probs
